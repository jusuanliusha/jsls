...
public class ActionInfo {
    ...
    public static void processAction(ActionInfo actionInfo) {
        UserInfo userInfo = currUserInfo(WebUtils.getRequest());
        actionInfo.userId = userInfo.getUserId() + "";
        actionInfo.userNickName = userInfo.getNickName();
    }

    public static String currUsername() {
        return currSessionUser().getUsername();
    }

    public static String currUserId() {
        return currSessionUser().getUserId() + "";
    }

    public static UserInfo currSessionUser() {
        return currUserInfo(WebUtils.getRequest());
    }
    ...
    public static UserInfo currUserInfo(HttpServletRequest request) {
